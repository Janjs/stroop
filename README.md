...
**Next.js app (Coolify)** — set **NEXT_PUBLIC_CONVEX_URL** to `https://backend.stroop.app`. The frontend talks to Convex at this URL. Do not set it to the Next.js app URL.
