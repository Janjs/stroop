...
**Next.js app (Coolify)** — set **NEXT_PUBLIC_CONVEX_URL** to the Convex backend URL. The frontend talks to Convex at this URL. Do not set it to the Next.js app URL.
