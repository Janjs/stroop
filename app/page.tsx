...
const Page = () => {
  ...
  const showMobileTopBar = !isLoading && isAuthenticated
      ...
      <div className="flex w-full flex-1 items-center justify-center px-5 py-10 md:px-10 lg:px-16">
        <div className="flex w-full max-w-6xl flex-col gap-12 md:flex-row md:items-center md:gap-12 lg:gap-20">
          <div className="flex flex-col gap-5 md:w-[55%]">
            <div className={showMobileTopBar ? 'hidden md:block' : undefined}>
              <ChordwiseBadge />
            </div>
            ...
            <p className="landing-subtitle max-w-lg text-base font-medium leading-relaxed text-muted-foreground md:text-lg">
